...
import com.cn.entity.ServiceList;
...
public class AuthService {
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret){
        ...
        ServiceInstance serviceInstance = loadBalancerClient.choose(ServiceList.SECURITY_CLIENT);
        //此地址就是http://ip:port
        ...
        if(bodyMap == null ||
            ...
            if(bodyMap!=null && bodyMap.get("error_description")!=null){
                ...
                if(error_description.indexOf("UserDetailsService returned null")>=0){
                    ExceptionCast.cast(ResultEnum.AUTH_ACCOUNT_NOTEXISTS);
                }else if(error_description.indexOf("坏的凭证")>=0){
                    ExceptionCast.cast(ResultEnum.AUTH_CREDENTIAL_ERROR);
                }
            }
